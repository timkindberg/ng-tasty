...
var $__rtts_95_assert_47_rtts_95_assert__,
    ...
    $__shadow_95_dom_95_emulation_47_shadow_95_css__,
    $__style_95_inliner__,
    $__style_95_url_95_resolver__,
    $__directive_95_metadata__,
    $__pipeline_47_compile_95_step__,
    $__pipeline_47_compile_95_element__,
    $__pipeline_47_compile_95_control__;
...
var ShadowCss = ($__shadow_95_dom_95_emulation_47_shadow_95_css__ = require("./shadow_dom_emulation/shadow_css"), $__shadow_95_dom_95_emulation_47_shadow_95_css__ && $__shadow_95_dom_95_emulation_47_shadow_95_css__.__esModule && $__shadow_95_dom_95_emulation_47_shadow_95_css__ || {default: $__shadow_95_dom_95_emulation_47_shadow_95_css__}).ShadowCss;
var StyleInliner = ($__style_95_inliner__ = require("./style_inliner"), $__style_95_inliner__ && $__style_95_inliner__.__esModule && $__style_95_inliner__ || {default: $__style_95_inliner__}).StyleInliner;
...
var NS = ($__pipeline_47_compile_95_step__ = require("./pipeline/compile_step"), $__pipeline_47_compile_95_step__ && $__pipeline_47_compile_95_step__.__esModule && $__pipeline_47_compile_95_step__ || {default: $__pipeline_47_compile_95_step__});
var CompileElement = ($__pipeline_47_compile_95_element__ = require("./pipeline/compile_element"), $__pipeline_47_compile_95_element__ && $__pipeline_47_compile_95_element__.__esModule && $__pipeline_47_compile_95_element__ || {default: $__pipeline_47_compile_95_element__}).CompileElement;
var CompileControl = ($__pipeline_47_compile_95_control__ = require("./pipeline/compile_control"), $__pipeline_47_compile_95_control__ && $__pipeline_47_compile_95_control__.__esModule && $__pipeline_47_compile_95_control__ || {default: $__pipeline_47_compile_95_control__}).CompileControl;
var _EMPTY_STEP;
function _emptyStep() {
...
($traceurRuntime.createClass)(_BaseEmulatedShadowDomStep, {process: function(parent, current, control) {
...
($traceurRuntime.createClass)(_EmptyCompileStep, {process: function(parent, current, control) {
    assert.argumentTypes(parent, CompileElement, current, CompileElement, control, CompileControl);
  }}, {}, NS.CompileStep);
